...
<div class="header">
	<div class="header-left">
		<a href="#"><span>Marriage</span> Intrepreter</a>
	</div>
		...
		<span class="menu"><img src="images/menu.png" alt=""/></span>
			<nav class="cl-effect-11" id="cl-effect-11">	
				<ul class="nav1">	
				  ...
				  <li><a href="order.php" data-hover="Orders">o</a>Orders</li>
				  <li><a href="districts.php" data-hover="Districts">Districts</a></li>
				  <li><a href="places.php" data-hover="place">place</a></li>
				  <li><a href="Category.php" data-hover="Category">Category</a></li>
				  <li><a href="functions.php" data-hover="functions">functions</a></li>
...
<table align="center" cellpadding="10" cellspacing="10" width="400">
    ...
    <tr>
    	<td colspan="2" align="center"><H2>USER HOME</H2></td>
    </tr>
